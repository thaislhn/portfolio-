      ...
      <div className="relative z-10 min-h-screen px-6 md:px-12 lg:px-24 py-20 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 text-white/60 text-sm">
            ...
            <span className="hidden md:inline">•</span>
            <a href="https://www.linkedin.com/in/tha%C3%AFs-l%27hocine-795747280" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              ...
              <p className="text-white/70 text-base leading-relaxed">
                Bonjour ! Actuellement étudiante en DN MADE Design numérique (code/IA créativité) à Gobelins Paris, 
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-2 border-white/30 pl-6 pb-4">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-white text-lg font-light">DN MADE mention numérique (code/IA créativité)</h3>
